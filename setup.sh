...
RTMPIE_MERCURE_PUBLISHER_JWT_KEY=$(rand)
RTMPIE_MERCURE_SUBSCRIBER_JWT_KEY=$(rand)
...
RTMPIE_MERCURE_PUBLISHER_JWT_KEY=${RTMPIE_MERCURE_PUBLISHER_JWT_KEY}
RTMPIE_MERCURE_SUBSCRIBER_JWT_KEY=${RTMPIE_MERCURE_SUBSCRIBER_JWT_KEY}
